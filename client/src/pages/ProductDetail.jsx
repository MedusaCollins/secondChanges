...
export default function ProductDetail({user, islogging, handleLogin}){
  ...
  <div className='mx-auto max-w-[1200px]'>
    ...
    <div className="flex flex-col justify-between pt-11">
      <div className='flex lg:flex-row flex-col gap-5 justify-between mb-12 px-5'>
        ...
        <About product={product} rating={rating} user={user} comments={comments} setComments={setComments} islogging={islogging} handleLogin={handleLogin}/>
      </div>
      {("buyers" in product)&&(
        <>
        {("comment" in product.buyers)&&(
          <Link to={`/profiles/${product.buyers._id.username}`}>
